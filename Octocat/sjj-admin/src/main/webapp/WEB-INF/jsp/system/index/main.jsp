...
<base href="<%=basePath%>">
	...
	<body class="no-skin">
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div hidden class="ace-settings-container" id="ace-settings-container">
		...
		<script type="text/javascript">
			$(function(){
				//选择第2种皮肤
				$("#skin-colorpicker").find("option:eq(1)").attr("selected","selected");
				$("#skin-colorpicker").change();
				//选择压缩菜单
				$("#ace-settings-compact").attr("selected","selected");
